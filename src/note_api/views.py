...
class RegisterViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        return Response({'message': 'Register failed', 'status': False, 'data': {}})
...
class CategoryViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            category.save()
            return Response({'message': 'Success', 'status': True, 'data': serializer.data})
        return Response({'message': 'Create Category failed', 'status': False, 'data': {}})
    ...
    def partial_update(self, request, pk = None):
        ...
        if category is None:
            ...
            if serializer.is_valid(raise_exception=True):
                serializer.save()
                return Response({'message': 'Success', 'status': True, 'data': serializer.data})
            return Response({'message': 'Partial Update Category failed', 'status': False, 'data': {}})
...
class NoteViewSet(viewsets.ViewSet):
    permission_classes = (IsAuthenticated,)
    authentication_classes = (TokenAuthentication,)
    serializer_class = NoteDescriptionSerializer

    def create(self, request):
        serializer = NoteDescriptionSerializer(data=request.data)
        if serializer.is_valid(raise_exception=True):
            ...
            note.save()
            return Response({'message': 'Success', 'status': True, 'data': serializer.data})
        return Response({'message': 'Create Note failed', 'status': False, 'data': {}})

    def list(self, request):
        notes = Note.objects.select_related('user').filter(user=request.user)
        serializer = NoteDescriptionSerializer(notes, many=True)
        return Response({'message': 'Success', 'status': True, 'data': serializer.data})
    ...
    def retrieve(self, request, pk = None):
        ...
        if note is None:
            ...
            serializer = NoteDescriptionSerializer(note, many=False)
            return Response({'message': 'Success', 'status': True, 'data': serializer.data})
    ...
    def partial_update(self, request, pk = None):
        ...
        if note is None:
            ...
            serializer = NoteDescriptionSerializer(note, data = request.data, partial = True)
            if serializer.is_valid(raise_exception=True):
                serializer.save()
                return Response({'message': 'Success', 'status': True, 'data': serializer.data})
            return Response({'message': 'Partial Update Note failed', 'status': False, 'data': {}})
